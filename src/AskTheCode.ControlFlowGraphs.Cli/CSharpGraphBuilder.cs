...
namespace AskTheCode.ControlFlowGraphs.Cli
{
    ...
    internal class CSharpGraphBuilder
    {
        ...
        public class BuildingContext : IBuildingContext
        {
            ...
            {
                Contract.Requires(
                    this.Graph.LocalInstanceModel == null
                    || this.Graph.LocalInstanceModel.Type == localType);

                if (this.Graph.LocalInstanceModel == null)
                {
                    this.Graph.LocalInstanceModel = (ReferenceModel)this.CreateVariableModel(
                ...
                return this.Graph.LocalInstanceModel;
            }
